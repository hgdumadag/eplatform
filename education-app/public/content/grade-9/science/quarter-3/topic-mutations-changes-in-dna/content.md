...
> [!GOAL] Learning Goal
>
> By the end of this lesson, you should be able to describe mutations as changes in DNA or chromosomes and discuss factors that cause mutations.
...
|---|---|---|
| **Mutation** | a change in DNA or chromosomes | A base in a DNA sequence changes |
| **Mutagen** | a factor that can cause mutations | UV radiation is a mutagen |
| **Radiation** | energy that can damage DNA at high exposure | Too much UV light can damage skin-cell DNA |
| **Chemical mutagen** | a substance that can damage DNA | Some pollutants can increase mutation risk |
...
![DNA sequence before and after mutation](./images/mutation-before-after.svg)

*One base changes in a sequence.*

![Sources of mutations](./images/mutagen-sources.svg)

*Radiation, chemicals, and infectious agents.*

![Body cell vs reproductive cell mutation](./images/cell-line.svg)

*Only reproductive-cell changes can be inherited.*
...
A mutation is a change in DNA or chromosomes. Mutations can happen during DNA copying or can be triggered by mutagens such as radiation, certain chemicals, or some infectious agents.
...
>
> A mutation is a change in DNA or chromosomes. Mutations can happen during DNA copying or can be triggered by mutagens such as radiation, certain chemicals, or some infectious agents. For this Grade 9 Biology lesson, a strong answer uses correct vocabulary, a labeled diagram, and a relevant example.

## Worked Examples

| Example | Biological Explanation |
|---|---|
| Copying error | A DNA base may be copied incorrectly during cell division. |
| Environmental cause | Excessive UV exposure can damage DNA in skin cells. |
...
1. Define **Mutation** in one student-friendly sentence.
...
- Mutation does not always mean a dramatic visible change.
- Not every mutation is inherited; only mutations in reproductive cells can be passed to offspring.
...
> The key idea is **Mutation**. It matters because a mutation is a change in dna or chromosomes. One example is ________, where ________ leads to ________.
...
Mutations: Changes in DNA helps you understand Grade 9 Life Science by connecting models, evidence, and local examples. The lesson is not just a vocabulary list: you should be able to explain the relationships shown in the diagrams and use them in a new situation.
