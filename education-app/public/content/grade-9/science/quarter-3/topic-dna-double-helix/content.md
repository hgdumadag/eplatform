...
> [!GOAL] Learning Goal
>
> By the end of this lesson, you should be able to use models and labeled diagrams to represent the double helix structure of DNA.
...
|---|---|---|
| **DNA** | deoxyribonucleic acid, the molecule that stores genetic information | A DNA model shows instructions in a cell |
| **Double helix** | a twisted ladder shape made of two strands | The DNA molecule is a double helix |
| **Base pair** | two matching bases across the DNA ladder | A pairs with T; C pairs with G |
| **Sugar-phosphate backbone** | the side rails of the DNA ladder | The backbone holds the bases in order |
...
![Labeled DNA ladder](./images/dna-ladder.svg)

*Sugar-phosphate sides and A-T/C-G rungs.*

![Base pairing rules](./images/base-pairing.svg)

*A connects to T; C connects to G.*

![Double helix model](./images/twisted-helix.svg)

*A flat ladder twists into a helix.*
...
DNA is the molecule that carries biological instructions. Its double helix shape is like a twisted ladder: sugar-phosphate backbones form the sides, and paired bases form the rungs.
...
>
> DNA is the molecule that carries biological instructions. Its double helix shape is like a twisted ladder: sugar-phosphate backbones form the sides, and paired bases form the rungs. For this Grade 9 Biology lesson, a strong answer uses correct vocabulary, a labeled diagram, and a relevant example.

## Worked Examples

| Example | Biological Explanation |
|---|---|
| Base pairing | If one DNA strand has A, the opposite base is T. If it has C, the opposite base is G. |
| Model reading | In a diagram, the sequence of bases along a strand stores information. |
...
1. Define **DNA** in one student-friendly sentence.
...
- DNA is not only the shape; it also stores information in the order of bases.
- The bases do not pair randomly: A-T and C-G are the reliable pairing rules.
...
> The key idea is **DNA**. It matters because dna is the molecule that carries biological instructions. One example is ________, where ________ leads to ________.
...
The Structure of DNA: The Double Helix helps you understand Grade 9 Life Science by connecting models, evidence, and local examples. The lesson is not just a vocabulary list: you should be able to explain the relationships shown in the diagrams and use them in a new situation.
