...
<svg role="img" aria-label="Oxygen atom with six valence electrons" viewBox="0 0 620 260" width="100%" style="max-width:660px"><rect width="620" height="260" rx="18" fill="#f8fafc"/><text x="35" y="35" font-size="18" font-family="Arial">Valence electrons are on the outer shell</text><circle cx="210" cy="140" r="28" fill="#f97316"/><text x="198" y="146" font-size="18" fill="white">O</text><circle cx="210" cy="140" r="58" fill="none" stroke="#94a3b8" stroke-width="2"/><circle cx="210" cy="140" r="95" fill="none" stroke="#2563eb" stroke-width="3"/><g fill="#2563eb"><circle cx="210" cy="45" r="7"/><circle cx="292" cy="92" r="7"/><circle cx="292" cy="188" r="7"/><circle cx="210" cy="235" r="7"/><circle cx="128" cy="188" r="7"/><circle cx="128" cy="92" r="7"/></g><text x="350" y="105" font-size="16">Oxygen: Group 16</text><text x="350" y="135" font-size="16">6 valence electrons</text><text x="350" y="165" font-size="16">Needs 2 more for an octet</text></svg>
